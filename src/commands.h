...
#define EXTENDED_OPCONFIG_CLASSID               64
#define EXTENDED_DISCHARGE_CLASSID              49
...
#define EXTENDED_DISCHARGE_SOC_LOW_OFFSET       0
#define EXTENDED_DISCHARGE_SOC_CRITICAL_OFFSET  2
